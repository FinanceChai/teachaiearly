...
export function PrototypeBuilder({ onComplete }: { onComplete: () => void }) {
    ...
    return (
      <div className="p-6 bg-space-900 rounded-xl border border-slate-700 max-w-2xl mx-auto">
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-center">
          ...
          <h2 className="text-2xl font-bold text-white mt-2">Prototype Complete!</h2>
  ...
  if (phase === "fix") {
    ...
    return (
      <div className="p-6 bg-space-900 rounded-xl border border-slate-700 max-w-2xl mx-auto">
        <h2 className="text-xl font-bold text-white mb-2">🔧 Fix the Issue</h2>
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3 mb-4">
          ...
          <p className="text-slate-300 text-sm mt-1">{issue.issue}</p>
        </div>
  ...
  if (phase === "test") {
    ...
    return (
      <div className="p-6 bg-space-900 rounded-xl border border-slate-700 max-w-2xl mx-auto">
        <h2 className="text-xl font-bold text-white mb-2">🧪 Testing Your Prototype</h2>
        <p className="text-slate-300 text-sm mb-4">
        ...
        <motion.div
          ...
          className="bg-space-800 rounded-xl p-5 border border-slate-700 text-center mb-4"
        >
          <span className="text-4xl">{step.emoji}</span>
          <p className="text-white font-bold mt-2">{step.action}</p>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
  ...
  return (
    <div className="p-6 bg-space-900 rounded-xl border border-slate-700 max-w-2xl mx-auto">
      <h2 className="text-xl font-bold text-white mb-1">🔨 Prototype Builder</h2>
      ...
      <div className="bg-space-800 rounded-xl p-4 border border-slate-700 mb-3 min-h-[200px]">
        ...
        <div className="space-y-2">
          ...
          {screenComponents[currentScreen].length === 0 && (
            <div className="border-2 border-dashed border-slate-600 rounded-lg p-6 text-center">
              <p className="text-slate-500 text-sm">Click components below to add them here!</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        {COMPONENTS.map((comp, i) => (
          <motion.button
            ...
            className="p-2 bg-space-800 rounded-lg border border-slate-700 hover:border-lime-500 disabled:opacity-40"
          >
