    ...
    <div className="space-y-5">
      ...
      <div className="bg-space-800 rounded-2xl p-5 border border-slate-200">
        ...
        <motion.div key={idx} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
            ...
            {!showData ? (
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-2">
                <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3">
                  ...
                  <div className="text-sm text-slate-600">{s.trainingData}</div>
                </div>
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                  <div className="text-xs font-black text-red-400 mb-1">RESULT</div>
                  <div className="text-sm text-slate-600">{s.outcome}</div>
                </div>
              </motion.div>
            )}
          </div>
          ...
          {showData && (
            <>
              <div className="text-slate-900 font-black text-sm mb-3">{s.question}</div>
              {picked === null ? (
