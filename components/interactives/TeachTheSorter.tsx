      ...
      <div className="space-y-5">
        <div className="bg-space-800 rounded-2xl p-5 border border-green-500/30">
          <div className="text-center mb-4">
            ...
            <div className="font-black text-slate-900">Train the Sorter!</div>
          ...
          <div className="space-y-2">
            {TRAINING_DATA.map((item) => (
              ...
              >
                ...
                <span className="text-slate-900 font-bold flex-1">{item.label}</span>
                <button
    ...
    return (
      <div className="space-y-5">
        <div className="bg-space-800 rounded-2xl p-5 border border-green-500/30">
          <div className="text-center mb-4">
            <div className="text-3xl mb-2">🧪</div>
            <div className="font-black text-slate-900">Test the AI!</div>
            <div className="text-sm text-slate-400 mt-1">
