    ...
    <div className="min-h-screen bg-space-900 text-slate-600">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">4. Free and Paid Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">5. Subscriptions and Billing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">6. Children&apos;s Privacy (COPPA)</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">7. Acceptable Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">8. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">9. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">10. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 mb-3">11. Contact</h2>
            <p>
