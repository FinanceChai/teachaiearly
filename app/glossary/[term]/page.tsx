    ...
    <div className="min-h-screen bg-space-900">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-10">
          ...
          <span>/</span>
          <span className="text-slate-600">{fc.term}</span>
        </div>
        ...
        {/* Why it matters */}
        <div className="mb-10 bg-mint-400/5 rounded-2xl p-6 border border-teal-500/20">
          <h2 className="text-sm font-black text-sky-500 mb-2">
            Why does this matter?
          </h2>
          <p className="text-slate-400 text-sm leading-relaxed">
            Understanding <strong className="text-slate-900">{fc.term}</strong> is
        ...
        <div className="mb-10 bg-space-800 rounded-2xl p-6 border border-slate-200 text-center">
          <p className="text-slate-400 text-sm mb-4">
            Learn about <strong className="text-slate-900">{fc.term}</strong> with
            hands-on interactive lessons
          </p>
          <Link
            href="/"
            className="inline-block bg-gradient-to-r from-sky-400 to-mint-300 hover:from-sky-300 hover:to-mint-200 text-slate-900 font-bold px-6 py-3 rounded-xl btn-press transition-all shadow-lg text-sm"
          >
            Start Learning Free
          </Link>
        </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid gap-3">
              {related.map((r) => (
                ...
                >
                  <h3 className="font-bold text-slate-900 group-hover:text-sky-500 transition-colors text-sm">
                    {r.term}
                  </h3>
